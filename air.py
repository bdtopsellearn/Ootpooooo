...
def main():
    ...
    # Render Web Service health endpoint. The Telegram bot continues using polling.
    try:
        ...
        threading.Thread(target=health_server.serve_forever, name="render-health", daemon=True).start()
        print(f"🌐 Health server listening on port {port}")
    except Exception as exc:
        print(f"⚠️ Health server not started: {exc}")
